...
We begin by visualising the data to check for location errors, and find a single outlier position approx. 15km away from the study area (Fig. 1.1, 1.2).
...
This speed threshold is chosen as 5 m/s faster than the known boat speed, 10 m/s.
Finally, we target small-scale location errors by applying a median smooth with a moving window size $K$ = 5 using the function `atl_median_smooth` (Fig. 1.4; main text Fig. 7.c).
