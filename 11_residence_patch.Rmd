...
patch <- atl_res_patch(data, buffer_radius = 0.01, 
                       lim_spat_indep = 0.05, lim_time_indep = 5)

patch_sf <- atl_patch_summary(patch_data = patch, which_data = "summary", buffer_radius = 0.01)
```
