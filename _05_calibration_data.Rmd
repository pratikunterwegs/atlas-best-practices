...
patch_res_known <- atl_res_patch(data_recurse, 
                                buffer_radius = 5,
                                lim_spat_indep = 50,
                                lim_time_indep = 5,
                                min_fixes = 3)
...
# compare real and inferred duration
patch_summary_compare[, duration_diff := (duration - duration_real) / duration_real]

# get mean and sd of duration difference
patch_summary_compare[, .(mean_diff = mean(duration_diff),
                          sd_diff = sd(duration_diff))]
```
