...
\KeywordTok{cat}\NormalTok{(}
  \KeywordTok{readLines}\NormalTok{(}
    \DataTypeTok{con =} \StringTok{"data/model\_output\_residence\_patch.txt"}\NormalTok{,}
    \DataTypeTok{encoding =} \StringTok{"UTF{-}8"}
\NormalTok{  ), }\DataTypeTok{sep =} \StringTok{"}\CharTok{\textbackslash{}n}\StringTok{"}
\NormalTok{)}
\CommentTok{\#> }
\CommentTok{\#> Call:}
\CommentTok{\#> lm(formula = duration\_real \textasciitilde{} duration, data = patch\_summary\_compare)}
\CommentTok{\#> }
