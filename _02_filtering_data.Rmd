...
```{r echo=FALSE}
# save figure
ggsave(fig_outlier_remove, 
       filename = "figures/fig_03_filter_speed.png", 
       width = 80, height = 150, units = "mm")
```

![](figures/fig_03_filter_speed.png)
